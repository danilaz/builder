...
<div class="bigbox">
	<div class="bigboxhead">Модуль макета</div>
	<div class="bigboxbody">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
    <td width="12%" height="44">Название</td>
    <td width="88%">
    <input name="title" type="text">
    </td>
    </tr>
  <tr>
    <td width="12%" height="44">Позиция</td>
    <td width="88%">
  ...
  <tr>
    <td height="46">Название модуля</td>
    <td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><label>
      <input class="btn" type="submit" name="submit" id="submit" value="Добавить">
    </label></td>
  </tr>
</table>
...
<div class="bigbox" style="margin-top:5px;">    
    <div class="bigboxhead">Список модулей</div>
	<div class="bigboxbody">
    
    
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr >
    <td width="13%">Порядок</td>
    <td width="*%">Название</td>
    <td width="32%">Модуль</td>
    <td width="25%">Положение</td>
    <td width="17%">Действие</td>
  </tr>
  <?php
  ...
  <tr>
    ...
    <td>
	<a href="module.php?m=special&s=special_con.php&deid=<?php echo $v['id'];?>&id=<?php echo $de['id'];?>">Удалить</a> | 
	<a href="module.php?m=special&s=modules_con_set.php&type=<?php echo $v['name'];?>&id=<?php echo $v['id'];?>">Настройка модуля</a>
	</td>
  </tr>
  <?php 
  }
  ?>
    <tr>
    <td colspan="5"><label>
      <input class="btn" type="submit" name="update" id="update" value="Обновить порядок">
    </label></td>
    </tr>
</table>
