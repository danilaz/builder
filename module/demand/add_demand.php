...
include_once("$config[webroot]/module/demand/lang/".$config['language']."/admin_demand.php");
...
if(!empty($_POST['submit'])){	
	...
	//=================================================================
	echo "<script>parent.window.reqComplete(".$status['login'].",".$status['demand'].");</script>";
	die();
}else{
