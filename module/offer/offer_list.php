...
if(is_numeric($id))
{
	...
	if(isset($cat['pcat']['catid']))
		$pcat=" <a href='$config[weburl]/?m=offer&s=offer_list&id=".$cat['pcat']['catid']."'>".$cat['pcat']['cat']."</a> &raquo; ";
	$guide=$pcat.$cat['cat'];
...
//$sql="SELECT a.id,a.type,a.title,a.con,a.userid,a.user,a.uptime,a.rank,a.pic,a.country,a.province,a.city,a.company,c.flag FROM  ".INFO." a left join ".COUNTRY." c on a.country=c.id WHERE a.statu>0 $sub_sql ORDER BY a.rank desc,a.ifpay desc,a.uptime DESC"; 
//$sql="SELECT * FROM b2bbuilder_offer WHERE 1=1"; 
...
$tpl->assign("subcat",readsubcat($id,'offercat','all'));
$tpl->assign("infoType",$infoType);
$tpl->assign("current","offer");
//===================================================================
include_once("footer.php");
$out=tplfetch("offer_list.htm");
?>