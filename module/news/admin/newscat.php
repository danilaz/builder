...
<form onSubmit="return Validator.Validate(this,4)" name="form2" method="post">
	...
	<div class="bigboxbody">
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="17%"><?php echo lang_show('catrank');?></td>
          <td width="83%"><select name="pid" id="pid">
        ...
        <tr>
          ...
          <td><input style="width:300px" dataType="Require" msg="<img src='../image/default/no_right.gif'>" name="cat" type="text" id="cat" value="<?php echo $de['cat']; ?>"></td>
        </tr>
        <tr>
          <td>Logo</td>
          <td>
             <input style="width:300px" value="<?php echo $de['pic']; ?>" name="pic" type="text" id="pic">
			 [<a href="javascript:uploadfile('Загрузка логотипа','pic',85,32)">Загрузить</a>] 
        ...
        <tr>
          ...
          <td><input type="text" name="template" id="template" value="<?php echo $de['template']; ?>"></td>
        </tr>
        <tr>
          <td><?php echo lang_show('openpost');?><a title="<?php echo lang_show('openpostdes');?>" href="#">?</a></td>
          <td><input type="checkbox" name="openpost" id="openpost" value="1" <?php if(!empty($de['openpost'])&&$de['openpost']==1) echo "checked"; ?>>          </td>
        </tr>
        <tr>
          <td><?php echo lang_show('show');?><a title="<?php echo lang_show('showdes');?>" href="#">?</a></td>
          <td><input name="ishome" type="checkbox" value="1" <?php if(!empty($_GET['ishome'])&&$_GET['ishome']==1) echo "checked"; ?> ></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>
