...
<body>
<!--<div class="guidebox">
<?php echo lang_show('system_setting_home');?> &raquo; <?php echo lang_show('news_manager');?></div>-->
<div class="bigbox">
...
<{/foreach}>
  ...
  <tr>
	...
	?> 
      ...
      <tr>
    <td><?php echo lang_show('fregion');?></td>
    <td>
		<?php
        $ar_rc_type = array (
            '0'=>lang_show('lasted'),
  ...
  <tr>
    ...
    <td>
      <input name="from" type="checkbox" id="from" value="true" <?php if(!empty($news_label['from'])) echo 'checked';?> >      </td>
    </tr>
  <tr>
    <td><?php echo lang_show('showpic');?></td>
    <td>
    <?php if(!empty($news_label['time'])){ ?>
    <input name="time" type="hidden" value="<?php echo $news_label['time'];?>">
    <?php } ?>
      <input name="image" type="checkbox" id="image" value="1" <?php if(!empty($news_label['image'])) echo 'checked';?> >      </td>
    </tr>
...
<div class="bigbox">
  ...
  <table width="100%" border="0" align="left" cellpadding="2" cellspacing="0" >
    ...
    <tr bgcolor="#eeeeee"> 
      ...
      <td>
        <input name="textfield" type="text" id="textfield" value="<{insert name='label' type='news' labelid='<?php echo $news_label['time'];?>'}>" size="60">
        
      </td>
      <td><?php echo dateformat($news_label['time']); ?></td>
      <td width="191" align="center">
      <a href="module.php?m=<?php echo $_GET['m'];?>&s=<?php echo $_GET['s'];?>&time=<?php echo $news_label['time'];?>"><?php echo lang_show('edit');?></a>
      <a href="module.php?m=<?php echo $_GET['m'];?>&s=<?php echo $_GET['s'];?>&del=<?php echo $news_label['time'];?>"><?php echo lang_show('delete');?></a>      </td>
    </tr>
    <?php
	unset($news_label); 
	}}
