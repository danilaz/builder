<?php /* Smarty version 2.6.20, created on 2013-02-02 12:16:59
         compiled from admin_demand_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin_demand_list.htm', 39, false),)), $this); ?>
...
<button onclick="window.location='main.php?action=m&m=demand&s=admin_demand_list&menu=info&update=all'" style="float:right; margin-right:10px; height:22px; ">
...
&m=demand&s=admin_demand&action=m&menu=info"><img src="/image/default/page_edit.png" title="<?php echo $this->_tpl_vars['lang']['modify']; ?>
"></a>
	  <span id="r<?php echo $this->_tpl_vars['list']['id']; ?>
"><a href="javascript:ref(<?php echo $this->_tpl_vars['list']['id']; ?>
,'action=m&m=demand&s=admin_demand_list&menu=info&update=<?php echo $this->_tpl_vars['list']['id']; ?>
')">
...
&m=demand&s=admin_demand_list&action=m&menu=info" onclick="return confirm('<?php echo $this->_tpl_vars['lang']['sure_del']; ?>
');">
