<?php /* Smarty version 2.6.20, created on 2013-01-13 21:00:19
         compiled from demand_detail.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'regex_replace', 'demand_detail.htm', 15, false),array('modifier', 'strip_tags', 'demand_detail.htm', 17, false),array('modifier', 'date_format', 'demand_detail.htm', 114, false),array('modifier', 'truncate', 'demand_detail.htm', 182, false),array('insert', 'label', 'demand_detail.htm', 62, false),array('function', 'html_image', 'demand_detail.htm', 66, false),array('function', 'geturl', 'demand_detail.htm', 181, false),)), $this); ?>
...
/?m=demand%26s=demand_detail%26id=<?php echo $_GET['id']; ?>
';
...
<div class="leftbar_detail">
	...
	<div class="newstitle">Тип: <?php echo $this->_tpl_vars['de']['demandtype']; ?>
...
/?m=demand&s=demand_detail&id=<?php echo $this->_tpl_vars['de']['id']; ?>
>
...
<?php endif; ?><?php endforeach; endif; unset($_from); ?></td>
                 ...
                 <tr>
					 ...
					 <td class="pro_text"><?php echo $this->_tpl_vars['cominfo']['province']; ?>
<?php echo $this->_tpl_vars['cominfo']['city']; ?>
                ...
                <tr>
				 <td colspan="2" class="pro_text_demand_my"><?php echo $this->_tpl_vars['lang']['summary']; ?>
</td>
				 </tr>
...
" href="?m=demand&s=demand_down&id=<?php echo $this->_tpl_vars['list']['id']; ?>
&de=<?php echo $this->_tpl_vars['list']['file_url']; ?>
">
                        <img height="60px;" src="<?php echo $this->_tpl_vars['list']['thumb_img']; ?>
">
                        </a><br />
                        <a style="font-size:11px;" href="?m=demand&s=demand_down&id=<?php echo $this->_tpl_vars['list']['id']; ?>
&de=<?php echo $this->_tpl_vars['list']['file_url']; ?>
...
/?m=demand&s=demand_list&id=<?php echo $this->_tpl_vars['de']['catid']; ?>
"><?php echo $this->_tpl_vars['lang']['more']; ?>
            ...
            <table width="100%" border="0" cellspacing="5" cellpadding="0" style="text-align:left;">
              <tr>
              <?php $_from = $this->_tpl_vars['reldemand']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['num'] => $this->_tpl_vars['slist']):
?>
                <td height="22">
                <img src='<?php echo $this->_tpl_vars['config']['weburl']; ?>
/image/<?php echo $this->_tpl_vars['config']['temp']; ?>
/demand_<?php echo $this->_tpl_vars['slist']['type']; ?>
.gif' />
                <a href="<?php echo smarty_function_geturl(array('type' => 'demand_detail','user' => $this->_tpl_vars['slist']['user'],'uid' => $this->_tpl_vars['slist']['userid'],'tid' => $this->_tpl_vars['slist']['id'],'m' => 'demand'), $this);?>
">
                <?php echo ((is_array($_tmp=$this->_tpl_vars['slist']['title'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 44) : smarty_modifier_truncate($_tmp, 44)); ?>
	...
	<div class="right1 m1">
		<div class="sectitle" >
		 ...
		 <div class="seccon" id="pro_list">
			<?php $_from = $this->_tpl_vars['samedemand']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['list']):
?>
					
					<a href="<?php echo smarty_function_geturl(array('type' => 'demand_detail','user' => $this->_tpl_vars['list']['user'],'uid' => $this->_tpl_vars['list']['userid'],'tid' => $this->_tpl_vars['list']['id'],'m' => 'demand'), $this);?>
">
