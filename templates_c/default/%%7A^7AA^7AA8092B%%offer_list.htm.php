<?php /* Smarty version 2.6.20, created on 2013-01-13 14:18:07
         compiled from offer_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'label', 'offer_list.htm', 25, false),array('insert', 'getUser', 'offer_list.htm', 191, false),array('modifier', 'urlencode', 'offer_list.htm', 36, false),array('modifier', 'explode_one', 'offer_list.htm', 78, false),array('modifier', 'date_format', 'offer_list.htm', 86, false),array('modifier', 'strip_tags', 'offer_list.htm', 88, false),array('modifier', 'truncate', 'offer_list.htm', 88, false),array('function', 'html_image', 'offer_list.htm', 79, false),array('function', 'geturl', 'offer_list.htm', 90, false),)), $this); ?>
...
/?m=offer&s=offer_list&catType=<?php echo $_GET['catType']; ?>
&id=<?php echo $_GET['id']; ?>
...
/image/default/offer_<?php echo $this->_tpl_vars['list']['type']; ?>
.gif"  align="absmiddle">
				<a href="<?php echo $this->_tpl_vars['config']['weburl']; ?>
/?m=offer&s=offer_detail&id=<?php echo $this->_tpl_vars['list']['id']; ?>
" target="_blank" title="<?php echo $this->_tpl_vars['list']['title']; ?>
...
&action=offer_list&m=offer" target="_blank" style="color:#005BA6" />Все предложения</a> от компании <a rel="nofollow" style="color:#005BA6" href="<?php echo smarty_function_geturl(array('type' => '','uid' => $this->_tpl_vars['list']['userid'],'user' => $this->_tpl_vars['list']['user']), $this);?>
