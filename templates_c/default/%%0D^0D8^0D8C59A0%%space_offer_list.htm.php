<?php /* Smarty version 2.6.20, created on 2013-01-12 15:17:17
         compiled from space_offer_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'explode_one', 'space_offer_list.htm', 11, false),array('modifier', 'strip_tags', 'space_offer_list.htm', 23, false),array('modifier', 'truncate', 'space_offer_list.htm', 23, false),array('modifier', 'date_format', 'space_offer_list.htm', 25, false),array('function', 'html_image', 'space_offer_list.htm', 12, false),)), $this); ?>
<div class="common_box">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr><td class="guide_ba"><span><?php echo $this->_tpl_vars['lang']['offer_dir']; ?>
</span></td></tr>
<tr><td>
...
&action=offer_detail&id=<?php echo $this->_tpl_vars['list']['id']; ?>
&m=offer" title="<?php echo $this->_tpl_vars['list']['title']; ?>
" target="_blank">
	<?php else: ?>
...
<?php endif; ?>
<?php endforeach; else: ?>
	<?php echo $this->_tpl_vars['lang']['on_offers']; ?>
