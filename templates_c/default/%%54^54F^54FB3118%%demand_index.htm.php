<?php /* Smarty version 2.6.20, created on 2013-01-13 14:55:42
         compiled from demand_index.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'urlencode', 'demand_index.htm', 43, false),array('insert', 'getDemands', 'demand_index.htm', 57, false),array('insert', 'label', 'demand_index.htm', 112, false),array('insert', 'getUser', 'demand_index.htm', 202, false),)), $this); ?>
<div class="menu_bottom L1">				
    <div class="headtop_L">
        <a href='<?php echo $this->_tpl_vars['config']['weburl']; ?>
/'><?php echo $this->_tpl_vars['lang']['indexpage']; ?>
</a> &raquo; Каталог спроса</a>
    </div>
...
/?m=demand&s=demand_list&id&id=<?php echo $this->_tpl_vars['list']['catid']; ?>
...
?>     
           <a href="<?php echo $this->_tpl_vars['config']['weburl']; ?>
/?m=demand&s=demand_list&id=<?php echo $this->_tpl_vars['item']['catid']; ?>
...
<div class="top_branh">
  <div class="top_branh_tit">
    <img alt="<?php echo $this->_tpl_vars['list']; ?>
" src="<?php echo $this->_tpl_vars['config']['weburl']; ?>
/image/default/demand_1.gif"/><span class="yt_tit">Закупаем товары (платные объявления)</span>
  </div>
       <?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'getDemands', 'leng' => '30', 'type' => '1', 'rec' => 'true', 'limit' => '8', 'img' => 'true')), $this); ?>
...
<div class="top_branh">
  <div class="top_branh_tit">
    <img alt="<?php echo $this->_tpl_vars['list']; ?>
" src="<?php echo $this->_tpl_vars['config']['weburl']; ?>
/image/default/demand_2.gif"/><span class="yt_tit">Требуются услуги (платные объявления)</span>
  </div>
       <?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'getDemands', 'leng' => '300', 'type' => '2', 'rec' => 'true', 'limit' => '8', 'img' => 'true')), $this); ?>
...
<div class="top_pro">
  <div class="top_branh_tit">
    <img alt="<?php echo $this->_tpl_vars['list']; ?>
" src="<?php echo $this->_tpl_vars['config']['weburl']; ?>
/image/default/demand_1.gif"/><span class="yt_tit">Закупаем товары (новые объявления)</span>
  </div>
       <?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'getDemands', 'leng' => '30', 'type' => '1', 'limit' => '8', 'img' => 'true')), $this); ?>
...
<div class="top_pro"> 
  <div class="top_branh_tit">
    <img alt="<?php echo $this->_tpl_vars['list']; ?>
" src="<?php echo $this->_tpl_vars['config']['weburl']; ?>
/image/default/demand_2.gif"/><span class="yt_tit">Требуются услуги (новые объявления)</span>
  </div>
       <?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'getDemands', 'leng' => '300', 'type' => '2', 'limit' => '8', 'img' => 'true')), $this); ?>
  ...
  <div class="clear"></div>
		...
		<?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'label', 'type' => 'cat', 'temp' => 'demand_cat', 'ctype' => 'demand')), $this); ?>
