<?php /* Smarty version 2.6.20, created on 2013-01-13 15:42:08
         compiled from admin_offer.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'admin_offer.htm', 45, false),array('modifier', 'date_format', 'admin_offer.htm', 350, false),)), $this); ?>
...
<script type="text/javascript" src="<?php echo $this->_tpl_vars['config']['weburl']; ?>
/lib/upload/js/offer_handlers.js"></script>
...
"
		   ...
		   <?php endforeach; endif; unset($_from); ?>
<!--
<?php if (! $this->_tpl_vars['de']): ?><label><input onclick="toggAddPro()" type="radio" id="add_pro_online"  name="type" value="0" />Онлайн продажа</label><?php endif; ?>
-->
           </td>
        </tr><tr>
              <td bgcolor="#EAEFF3"><?php echo $this->_tpl_vars['lang']['titles']; ?>
<font color="red"> *</font> <a href="#" title="Здесь размещаются объявления о продаже товаров или услуг. Пример объявления о продаже товара: Стеклопластиковые насосно-компрессорные трубы. Неправильно: Трубы. Пример объявления о продаже услуг: Изготовим трубопроводы различных систем. Неправильно: Принимаем заявки на изготовление трубопроводов различных систем."><img src="../image/admin/Help Circle.jpg" border="0" ></a></td>
              <td bgcolor="#FFFFFF">
...
<a href="#" title="это ваши внутренние категории для более удобного структурирования ваших товаров и услуг"><img src="../image/admin/Help Circle.jpg" border="0" ></a></td>
			  <td bgcolor="#FFFFFF">
              <select name="custom_cat" style="width:133px">
