<?php /* Smarty version 2.6.20, created on 2013-01-13 17:49:14
         compiled from space_offer_detail.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'space_offer_detail.htm', 18, false),array('modifier', 'truncate', 'space_offer_detail.htm', 18, false),array('modifier', 'escape', 'space_offer_detail.htm', 18, false),array('modifier', 'date_format', 'space_offer_detail.htm', 71, false),array('insert', 'label', 'space_offer_detail.htm', 83, false),)), $this); ?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="guide_ba" colspan="3"><span style=" float:left;padding-left:10px;"><strong><?php echo $this->_tpl_vars['lang']['offers']; ?>
</strong></span></td>
    </tr>
  <tr>
...
.jpg" border=0 width="45" height="40">            </li>
    ...
    <td width="15%" height="32" class="borderC"><?php echo $this->_tpl_vars['lang']['offer_type']; ?>
</td>
    <td width="57%" height="32" class="borderC">
	<img border="0" src="<?php echo $this->_tpl_vars['config']['weburl']; ?>
/image/<?php echo $this->_tpl_vars['config']['temp']; ?>
/offer_<?php echo $this->_tpl_vars['info']['type']; ?>
.gif"/></td>
  </tr>
  <tr>
...
/<?php echo $this->_tpl_vars['info']['priceDes']; ?>
  ...
  <tr>
    ...
    <td class="borderC"><?php echo $this->_tpl_vars['info']['offer_type']; ?>
</td>
  </tr>
    <tr>
