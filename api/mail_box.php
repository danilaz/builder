...
.box{width:251px; height:auto; font-size:11px; font-family:Tahoma, arial;line-height:20px; color:#205394;}
.box input,textarea{border:1px solid #859DBC; width:150px; margin-left:8px;}
.title{background-image:url(../image/default/titleBg.gif); padding-left:7px; font-weight:bold; padding-top:1px; line-height:normal; height:18px;}
...
action="../shop.php?uid=<?php echo $_GET['uid'];?>&action=mail">
<div class="box" id="box">
  ...
  <tr>
    ...
    <td><input name="name" type="text" id="name" dataType="Require" msg="<?php echo $lang['rname'];?>" style="font-size:12px;" /></td>
  </tr>
  <tr>
    <td><?php echo $lang['email'];?></td>
    <td><input name="email" type="text" id="email" dataType="Require" msg="<?php echo $lang['remail'];?>" style="font-size:12px;" /></td>
  </tr>
  <tr>
    <td><?php echo $lang['tel'];?></td>
    <td ><input name="tell" type="text" id="tell" style="font-size:12px;" /></td>
  </tr>
  <?PHP } else { ?>
  <tr>
  ...
  <?php } ?>
    <tr>
      ...
      <td align="left">
      <input dataType="Require" msg="<?php echo $lang['ryzm'];?>" name="yzm" type="text" style="font-size:12px; width:40px; height:20px;" />
    ...
    <tr>
     <td></td>
      <td>
		...
		?>
		 <input style="background:#4595E6;border:1px solid #397CBF;color:#FFFFFF;font-size:11px; width:80px; height:22px; border:none" type="submit" name="imageField" value="<?php echo $lang['send'];?>" />
		 <input name="toid" type="hidden"  value="<?php echo $_GET['uid'];?>" />
		 <input name="submit" type="hidden" id="submit" value="submit" />
		 <input name="isflow" type="hidden" id="submit" value="submit" />
         <td>
   </tr>
</table>
	</div>
