...
?>
document.write('<div id="mailpop" style="position:absolute; right:0px;"><iframe src="api/mail_box.php?uid=<?php echo $_GET["uid"]; ?>" name="scbox" id="scbox" scrolling="no" frameborder="0" width="252" height="<?php if(isset($_COOKIE["USER"])) echo 208;else echo 257;?>"></iframe></div>');
...
function sc5()
{
win_obj.style.top=(document.documentElement.scrollTop+document.documentElement.clientHeight-win_obj.offsetHeight)+"px";
