...
class cls_image
{
    ...
    function make_thumb($img, $path = '',$thumb_width = 0, $thumb_height = 0,  $bgcolor='')
    {
		...
		//=======================================================
		if($thumb_width>400 && (isset($wmark_config['wmark_type']) && $wmark_config['wmark_type']!=0))
		{
			if($wmark_config['wmark_type']==1)
			{
				$water_img=$config['webroot']."/image/default/".$wmark_config['wmark_image'];
				$this->imageWaterMark($path,$wmark_config['wmark_locaction'],$water_img); 
			}
			else if($wmark_config['wmark_type']==2)
				$this->imageWaterMark($path,$wmark_config['wmark_locaction'],"",$wmark_config['wmark_words'],14,$wmark_config['wmark_words_color']); 
		}
		//========================================================
    }
...
function imageWaterMark($sourceImage,$waterPos=9,$waterImage="",$waterText="",$textFont=14,$textColor="#339900") 
{
	...
	imagejpeg($source_handle, $sourceImage);
