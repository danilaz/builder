...
class Page
{
   ...
   function prompt()
   {
   		...
   		if($this->nowPage<$this->totalPages)
		{
			...
			$nextPage  = " <a class='nextPage' href='".$this->url."?firstRow=$nextRow&totalRows=$this->totalRows$this->parameter'>Вперед</a>";
			$theEnd    = " <a href='".$this->url."?firstRow=$theEndRow&totalRows=$this->totalRows$this->parameter'>..$this->totalRows</a>";
        }
