...
$cache_dir[0][1]=lang_show('advs');

$cache_dir[1][0]="../cache/news_detail/";
$cache_dir[1][1]=lang_show('news');

$cache_dir[2][0]="../cache/apidata/";
$cache_dir[2][1]=lang_show('label');

$cache_dir[3][0]="../cache/pagedata/";
$cache_dir[3][1]=lang_show('other');

$cache_dir[4][0]="../cache/shop/";
$cache_dir[4][1]=lang_show('member');
...
<div class="bigbox">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  >
    ...
    <tr>
      ...
      <input name="de[]" type="checkbox" value="<?php echo $v[0];?>"></td>
	  <td width="*%" align="left"><?php echo $v[1];?> </td>
    </tr>
    <?php } ?>
    <tr>
      <td height="20" align="left"><label>
        <input onClick="do_select()" type="checkbox" name="checkbox" id="checkbox">
      </label>        </td>
