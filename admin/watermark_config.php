...
if(!empty($_POST['submit'])&&$_POST["submit"]==lang_show('submit'))
{
	...
	if((isset($configs['wmark_type']) && $configs['wmark_type'] == 1) && (!$configs['wmark_image'] || !file_exists("../image/default/".$configs['wmark_image']))){
		admin_msg(" watermark_config.php?not_exsit=1",'Водяной знак файл не существует');
	}else{
		admin_msg(" watermark_config.php?update=1",'Успешно сохранено!');
	}
	exit;
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >	
        <tr>
          <td  colspan="3" height="34" align="left" ><?php echo lang_show('wmark_config_msg');?></td>
        </tr>
		<tr>
          <td width="306" ><input type="radio" onClick="wmarkTypeChange(this.value);" name="wmark_type" id="wmark_type1" value="1" <?php
		  if (isset($wmark_config['wmark_type']) && $wmark_config['wmark_type']==1)
			echo "checked";
		  ?>><label for="wmark_type1"><?php echo lang_show('wmark_type_image');?></label></td><td width="277" ><input type="radio" onClick="wmarkTypeChange(this.value);" name="wmark_type" id="wmark_type2" value="2" <?php
		  if (isset($wmark_config['wmark_type']) && $wmark_config['wmark_type']==2)
			echo "checked";
		  ?>><label for="wmark_type2"><?php echo lang_show('wmark_type_words');?></label></td><td width="403" ><input type="radio" onClick="wmarkTypeChange(this.value);" name="wmark_type" id="wmark_type3" value="0" <?php
	  ...
	  <table width="100%">
        <tr>
          ...
          <td width="50" height="50" align="left" ><?php echo lang_show('wmark_words_color');?></td>
          <td width="300" align="left" >
   ...
   <div id="type_location" <?php if(isset($wmark_config['wmark_type']) && $wmark_config['wmark_type']==0) echo "style='display:none'"; else echo ""; ?>>
	  <table width="100%">
         <tr>
          ...
          <td><input type="radio" name="wmark_locaction" id="wmark_locaction1" value="1" <?php if (isset($wmark_config['wmark_locaction']) && $wmark_config['wmark_locaction']==1) echo "checked"; ?>> <label for="wmark_locaction1"><?php echo lang_show('wmark_location1');?></label> </td>

		  <td><input type="radio" name="wmark_locaction" id="wmark_locaction2" value="2" <?php if (isset($wmark_config['wmark_locaction']) && $wmark_config['wmark_locaction']==2) echo "checked"; ?>><label for="wmark_locaction2"><?php echo lang_show('wmark_location2');?></label></td>

		  <td><input type="radio" name="wmark_locaction" id="wmark_locaction3" value="3" <?php if (isset($wmark_config['wmark_locaction']) && $wmark_config['wmark_locaction']==3) echo "checked"; ?>><label for="wmark_locaction3"><?php echo lang_show('wmark_location3');?></label></td>
		</tr>

		</tr>
          <td><input type="radio" name="wmark_locaction" id="wmark_locaction4" value="4" <?php if (isset($wmark_config['wmark_locaction']) && $wmark_config['wmark_locaction']==4) echo "checked"; ?>> <label for="wmark_locaction4"><?php echo lang_show('wmark_location4');?></label> </td>

		  <td><input type="radio" name="wmark_locaction" id="wmark_locaction5" value="5" <?php if (isset($wmark_config['wmark_locaction']) && $wmark_config['wmark_locaction']==5) echo "checked"; ?>><label for="wmark_locaction5"><?php echo lang_show('wmark_location5');?></label></td>

		  <td><input type="radio" name="wmark_locaction" id="wmark_locaction6" value="6" <?php if (isset($wmark_config['wmark_locaction']) && $wmark_config['wmark_locaction']==6) echo "checked"; ?>><label for="wmark_locaction6"><?php echo lang_show('wmark_location6');?></label></td>
		</tr>

		</tr>
          <td ><input type="radio" name="wmark_locaction" id="wmark_locaction7" value="7" <?php if (isset($wmark_config['wmark_locaction']) && $wmark_config['wmark_locaction']==7) echo "checked"; ?>> <label for="wmark_locaction7"><?php echo lang_show('wmark_location7');?></label> </td>

		  <td ><input type="radio" name="wmark_locaction" id="wmark_locaction8" value="8" <?php if (isset($wmark_config['wmark_locaction']) && $wmark_config['wmark_locaction']==8) echo "checked"; ?>><label for="wmark_locaction8"><?php echo lang_show('wmark_location8');?></label></td>

		  <td ><input type="radio" name="wmark_locaction" id="wmark_locaction9" value="9" <?php if (isset($wmark_config['wmark_locaction']) && $wmark_config['wmark_locaction']==9) echo "checked"; ?>><label for="wmark_locaction9"><?php echo lang_show('wmark_location9');?></label></td>
		</tr>
		</table>
	  </div> 
...
function wmarkTypeChange(typeValue){
	if(typeValue==0){
		...
		$("type_location").style.display="none";
	}else if(typeValue==1){
		$("type1").style.display="";
		$("type2").style.display="none";
		$("type_location").style.display="";
	}else if(typeValue==2){
		$("type1").style.display="none";
		$("type2").style.display="";
		$("type_location").style.display="";
