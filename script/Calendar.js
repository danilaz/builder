...
Calendar.prototype.getStyle = function()
{
	...
	str += '.calendar{position:absolute;width:160px;height:184px;background-color:'+this.style.bodyBackColor+';border:1px solid ' + this.style.borderColor + ';left:0px;top:0px;overflow:hidden;z-index:'+this.z_index+';}\n';
	str += '.calendar table td{padding:0px;height:auto;line-height:20px;}\n';
	str += '.cdrHeader{background-color:'+ this.style.headerBackColor +';width:160px;height:22px;font-size:12px;font-family:"arial,helvetica,verdana,sans-serif";color:'+this.style.headerFontColor+';}\n';
	...
	str += '.cdrBodyBar{background-color:' + this.style.bodyBarBackColor + ';font-size:12px;font-family:"arial,helvetica,verdana,sans-serif";color:' + this.style.bodyBarFontColor + ';width:160px;height:20px;}\n';
	str += '.cdrBody{width:160px;height:122px;font-size:12px;font-family:"arial,helvetica,verdana,sans-serif";cursor:pointer;color:' + this.style.bodyFontColor + ';}\n';
	str += '.dayOver{height:16px;padding:0px;border:1px solid black;background-color:#f4f4f4;font-size:12px;font-family:"arial,helvetica,verdana,sans-serif";}\n';
	str += '.dayOut{padding:1px;border:none;height:16px;font-size:12px;font-family:"arial,helvetica,verdana,sans-serif";}\n';
    str += '.menuOver{background-color:'+this.style.headerBackColor+';color:'+this.style.headerFontColor+';font-size:12px;font-family:"arial,helvetica,verdana,sans-serif";}\n';
	str += '.headerOver{border:1px solid black;background-color:#f4f4f4;color:black;cursor:default;font-size:12px;font-family:"arial,helvetica,verdana,sans-serif";}\n';
	str += '.cdrMenu{font-size:12px;border:1px solid #000000;background-color:#ffffff;cursor:default;width:100%;font-size:12px;font-family:"arial,helvetica,verdana,sans-serif";}\n';
	str += 'html>body #Calendar{font-size:12px;font-family:"arial,helvetica,verdana,sans-serif";}';
	str += '</style>\n';	
	return str;
...
Calendar.prototype.getHeader = function()
{
	...
	str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" onmouseout="this.className=\'\'" id="previousYear" title="Предыдущий год" style="cursor:pointer;width:20px;" onclick="'+this.Obj+'.onChangeYear(false);"><<</td>\n';
	str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" onmouseout="this.className=\'\'" id="previousMonth" title="Предыдущий месяц" style="cursor:pointer;width:10px;" onclick="'+this.Obj+'.onChangeMonth(false);"><</td>\n';
	...
	str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" onmouseout="this.className=\'\'" id="nextMonth" title="Следующий месяц" style="cursor:pointer;width:10px;" onclick="'+this.Obj+'.onChangeMonth(true);">></td>\n';
	str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" onmouseout="this.className=\'\'" id="nextYear" title="Следующий год" style="cursor:pointer;width:20px;" onclick="'+this.Obj+'.onChangeYear(true);">>></td></tr>\n';
	str += '</table>\n';
	return str;
};
...
Calendar.prototype.getBody = function()
{
   ...
   str += '</table>\n';
   str += '<table Author="alin" class="cdrBodyBar" cellSpacing="0" cellPadding="0"><tr align="center" Author="alin"><td Author="alin" style="cursor:pointer;" onclick="'+this.Obj+'.getToday();">Сегодня '+new Date().toFormatString("yyyy mm dd")+'</td></tr></table>\n';
   return str;
};
...
Calendar.prototype.getMonthMenu = function()
{
   ...
   for(i = 1; i <= 12; i++)
	{   
		...
		str += 'onclick="' + this.Obj + '.bindDate(\'' + _date.toFormatString("-") + '\')">'+i+' мес.</td></tr>\n';
	}
   str += '</table>';
...
Calendar.prototype.show = function()
{
   ...
   for(i = 0; i < arguments.length; i++)
   {
	...
	if(!_date){alert("Ошибка параметра!"); return;}
